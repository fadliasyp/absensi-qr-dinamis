...
| Export database peserta PDF | PARTIAL | Export per kelompok mendukung pilihan 1–6 field inti/dinamis aktif, peserta aktif, kolom nomor, A4 potret dengan baris rapat, dan highlight jumlah gender; sintaks/regression test lulus tetapi output Supabase nyata belum diuji. |
...
- Export PDF hanya menerima field inti atau field dinamis aktif yang valid, maksimal enam field, dan hanya memuat peserta aktif dari kelompok terpilih.
