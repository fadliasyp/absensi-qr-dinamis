...
| Absensi peserta | WORKING | Validasi tetap lengkap tanpa geolocation; fallback ID perangkat, UI native tanpa CDN, serta query Supabase paralel/kolom minimum sudah ditambahkan. |
